...
from trace_memory.runtime.github import MAX_WEBHOOK_BYTES, GitHubWebhookRuntime
    ...
    def serve(self, *, host: str = "127.0.0.1", port: int = 8000) -> None:
        ...
        class Handler(BaseHTTPRequestHandler):
            ...
            def do_POST(self) -> None:  # noqa: N802
                ...
                application.metrics.increment("trace_webhooks_total", labels={"status": str(result.status_code)})
