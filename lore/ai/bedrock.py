...
class BedrockReasoner:
    """Configurable Anthropic-through-Bedrock reasoning with strict JSON validation."""
    ...
    def __init__(self, client: BedrockRuntime | None = None, *, model_id: str | None = None,
        ...
        self.model_id = model_id or os.environ.get(
            "BEDROCK_REASONING_MODEL_ID", "global.anthropic.claude-sonnet-4-5-20250929-v1:0"
        )
    ...
    def reason_json(self, *, system: str, user_content: str, output_type: type[T], max_tokens: int = 800) -> T:
        ...
        try:
            ...
            raise ValueError("Bedrock response failed LORE structured-output validation") from error
