...
class Memory(LoreModel):
    id: UUID = Field(default_factory=uuid4)
    organization_id: UUID
    repository_id: UUID
    display_id: str = Field(pattern=r"^LORE-MEMORY-[0-9]{3,}$")
...
class MemoryRelationship(LoreModel):
    id: UUID = Field(default_factory=uuid4)
...
class RetrievalEvent(LoreModel):
    id: UUID = Field(default_factory=uuid4)
    task_id: UUID
...
class RetrievalCandidate(LoreModel):
    id: UUID = Field(default_factory=uuid4)
...
class MemoryFeedback(LoreModel):
    id: UUID = Field(default_factory=uuid4)
    memory_id: UUID
