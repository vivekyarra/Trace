...
from lore.domain import AgentTask, OutboxEvent
from lore.runtime.tasks import EventAdmission
    ...
    def _request(self, method: str, path: str, payload: dict[str, object] | None = None) -> object:
        ...
        request = Request(
            ...
            headers={"Accept": "application/vnd.github+json", "Authorization": f"Bearer {self.token}",
                     "X-GitHub-Api-Version": "2022-11-28", "User-Agent": "lore-memory-runtime"},
        )
        try:
