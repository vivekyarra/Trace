"""Tests for trace_cli.validate — memory validation logic."""

from __future__ import annotations

import textwrap

from trace_cli.sync import parse_all_entries, parse_memory, parse_pattern_rule
from trace_cli.validate import validate_memories
