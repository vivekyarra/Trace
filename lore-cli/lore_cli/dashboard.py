"""lore dashboard -- generate a self-contained GitLab Pages HTML dashboard.

Reads parsed LORE memories and pattern rules, then produces a single
...
<title>LORE — Institutional Memory Dashboard</title>
<style>
:root {{
  --bg: #1a1a2e;
  --card-bg: #16213e;
...
<header>
  <h1>LORE</h1>
  <div class="subtitle">Living Organisational Record Engine &mdash; Institutional Memory Dashboard</div>
