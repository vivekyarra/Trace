"""lore stats — output JSON statistics about the LORE memory bank.
...
from lore_cli.sync import load_entries_from_file, parse_all_entries
...
def run_stats(args: argparse.Namespace) -> int:
    """Execute the ``lore stats`` command."""
