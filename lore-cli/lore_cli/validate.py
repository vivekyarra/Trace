"""lore validate — check memory format and dependency integrity.

Validates every LORE Memory entry against:
...
def validate_memories(
    ...
    """Validate a list of parsed LORE memories.
...
def run_validate(args: argparse.Namespace) -> int:
    """Execute the ``lore validate`` command."""
    ...
    if from_file:
        ...
        # Load from GitLab
        from lore_cli.sync import _collect_comments, _find_memory_bank_issue, _get_gitlab
